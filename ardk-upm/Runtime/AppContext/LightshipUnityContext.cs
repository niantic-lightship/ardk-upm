...
using System.Text;
using Niantic.Lightship.AR.Configuration;
...
namespace Niantic.Lightship.AR
{
    internal class LightshipUnityContext
    {
        ...
        internal static void Initialize(LightshipSettings settings, bool isDeviceLidarSupported)
        {
            ...
            {
                ApiKey = apiKeyToBeUsed,
                ScanningEndpoint = configurationProvider.ScanningEndpoint,
                ScanningSqcEndpoint = configurationProvider.ScanningSqcEndpoint,
                SharedArEndpoint = configurationProvider.SharedArEndpoint,
                VpsEndpoint = configurationProvider.VpsEndpoint,
                VpsCoverageEndpoint = configurationProvider.VpsCoverageEndpoint,
                DefaultDepthSemanticsEndpoint = configurationProvider.DefaultDepthSemanticsEndpoint,
                FastDepthSemanticsEndpoint = configurationProvider.FastDepthSemanticsEndpoint,
                SmoothDepthSemanticsEndpoint = configurationProvider.SmoothDepthSemanticsEndpoint,
            };
