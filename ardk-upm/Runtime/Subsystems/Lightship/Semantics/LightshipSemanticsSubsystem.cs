...
namespace Niantic.Lightship.AR
{
    ...
    /// </summary>
    [Preserve]
    class LightshipSemanticsSubsystem : XRSemanticsSubsystem, _ILightshipSettingsUser
    {
        ...
        internal class LightshipSemanticsProvider : Provider, _ILightshipSettingsUser
        {
            ...
            private const float _defaultConfidenceThreshold = -1.0f;
            ...
            internal bool SwitchToMockImplementation(IApi api = null)
            {
            ...
            /// <c>false</c>.
            /// </returns>
            public override bool TryGetSemanticChannel(string channelName, out XRTextureDescriptor semanticChannelDescriptor)
            {
                return _api.TryGetSemanticChannel(_nativeProviderHandle, channelName, out semanticChannelDescriptor);
            }
            ...
            /// <c>false</c>.
            /// </returns>
            public override bool TryGetPackedSemanticChannels(out XRTextureDescriptor packedSemanticsDescriptor)
            {
                return _api.TryGetPackedSemanticChannels(_nativeProviderHandle, out packedSemanticsDescriptor);
            }
            ...
            public override void Start()
            {
                ...
                for (int i = 0; i < confidenceList.Length; i++)
                    confidenceList[i] = _defaultConfidenceThreshold;
