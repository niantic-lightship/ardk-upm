...
namespace Niantic.Lightship.AR.Extensions.Gameboard {
    ...
    /// <summary>
    /// The ModelSettings struct provides a configuration for how Gameboard scans the real environment and creates a navigable space.
    /// An instance of ModelSettings is created by the GameboardManager using the parameters specified by the user in the Inspector,
    /// and that instance is subsequently used to create a Gameboard that is configured this way.
    /// </summary>
    [PublicAPI]
