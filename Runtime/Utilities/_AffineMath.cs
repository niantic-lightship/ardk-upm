...
namespace Utilities
{
  ...
  public static class _AffineMath
  {
    ...
    )
    {
      ...
      var rotate = ScreenRotation(from: sourceOrientation, to: targetOrientation);
      var scale = Scaling(s);
    ...
    private static Matrix4x4 ScreenRotation(ScreenOrientation from, ScreenOrientation to)
    {
      ...
      return Translation(-Center) * Rotation(GetRadians(from, to)) * Translation(Center);
    }
    ...
    internal static readonly Matrix4x4 InvertVertical
      = new(
        new Vector4(1, 0, 0, 0),
        new Vector4(0, -1, 1, 0),
        new Vector4(0, 0, 1, 0),
    ...
    internal static readonly Matrix4x4 InvertHorizontal
      = new(
        new Vector4(-1, 0, 1, 0),
        new Vector4(0, 1, 0, 0),
        new Vector4(0, 0, 1, 0),
