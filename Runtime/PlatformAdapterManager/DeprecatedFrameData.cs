...
{
    internal class DeprecatedFrameData
    {
        internal DeprecatedFrameCStruct _frameCStruct;

        private NativeArray<float> _poseData;

        // Location data
        private NativeArray<GpsLocationCStruct> _gpsData;
        private NativeArray<CompassDataCStruct> _compassData;
        ...
        public void SetGpsData(GpsLocationCStruct location)
        {
            _gpsData[0] = location;
        }

        public void SetCompassData(CompassDataCStruct compass)
        {
        ...
        internal DeprecatedFrameData()
        {
            ...
            _gpsData = new NativeArray<GpsLocationCStruct>(1, Allocator.Persistent);
            _frameCStruct.GpsLocationLength = 0; // Length is assigned when data is ready

            _compassData = new NativeArray<CompassDataCStruct>(1, Allocator.Persistent);
