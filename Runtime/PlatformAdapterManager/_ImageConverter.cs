...
{
    internal static class _ImageConverter
    {
        ...
        )
        {
            if (_material == null)
            {
                ...
                _material = new Material(lightshipImageConversionShader);
            }
            ...
            var displayTransform = _CameraMath.CalculateDisplayMatrix
            (
                inputResolution.x,
                inputResolution.y,
                outputWidth,
            ...
            _material.SetMatrix(UnityDisplayTransform, displayTransform);

            image.ReadFromExternalTexture(output, viewRect, _material);
