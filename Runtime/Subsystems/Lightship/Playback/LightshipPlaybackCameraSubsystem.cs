...
namespace Niantic.Lightship.AR.Playback
{
    ...
    public class LightshipPlaybackCameraSubsystem : XRCameraSubsystem, _IPlaybackDatasetUser
    {
        ...
        {
            // TODO: Support URP
            private List<string> m_LegacyRPEnabledMaterialKeywords;
            private List<string> m_LegacyRPDisabledMaterialKeywords;
            ...
            public override bool TryGetFrame(XRCameraParams cameraParams, out XRCameraFrame cameraFrame)
            {
                ...
                var displayMatrix =
                    ...
                    (
                        ...
                        frame.Orientation,
                        true,                           // Via ARF, external textures are formatted with their
